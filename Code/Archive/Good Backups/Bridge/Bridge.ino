...
// Array of commands for each wheel - generated from MATLAB script
...
void setup()
{
  // I know this should be somewhere between 90825 and 90750 - angle from lying down
  angle = 90900;//90750;
  Serial.begin(9600);
  prev_time = 0;
  ledYellow(0);
...
void newBalanceUpdate()
{
  ...
  // Disabled this because it was causing issues - use A to estop instead
  //  if (imu.a.x < 0)
  //  {
  //    lyingDown();
